...
class ReflectionGenerator:
    ...
    def _generate_code_files(self):
        ...
        custom_reflection_lines = [
            ...
            *[f'#include {inc}' for inc in sorted(list(all_handler_includes))],
            '',
        ]
        ...
        for cls in self.classes_to_reflect:
            ...
            # --- Part 3b: Attach the heuristically generated handler ---
            if class_name in generated_handlers:
                handler_name = generated_handlers[class_name]["func_name"]
                custom_reflection_lines.append(f'        desc.special_handler = &{handler_name};')

            # --- Part 3c: Finalize registration ---
